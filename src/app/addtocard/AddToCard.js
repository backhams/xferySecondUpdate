    ...
    <>
      ...
      >
        ...
        <div className="hidden md:block w-full ml-9">
          <button  className="bg-blue-500 text-white rounded-xl py-2 px-5 text-sm">Regular Item</button>
          <Link href={"/addtocard/trending"} className="bg-searchbox ml-7 text-white py-2 rounded-xl px-5 text-sm">Trending Item</Link>
        </div>
      ...
      <div className="md:hidden ml-3 flex mt-14 fixed bg-white z-10 w-full pt-7 pb-5">
        <button  className="bg-blue-500 text-white rounded-xl py-2 px-5 text-xs">Regular </button>
          <Link href={"/addtocard/trending"} className="bg-searchbox ml-5 text-white py-2 rounded-xl px-5 text-xs">Trending</Link>
        </div>
      <div className="flex justify-center h-screen overflow-auto z-0">
